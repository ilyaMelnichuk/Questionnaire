...
INSERT INTO security."user" (email, first_name, last_name, password, phone_number) VALUES('admin', 'admin', 'admin', '$2a$10$H.eAAMLvgIcscvJghcCn8ukzT0EpeFC6d0SuULXuq7VDJH8c5QNEu', '0000000') ON CONFLICT DO NOTHING; 	
