...
public interface UserRepository  extends CrudRepository<User, Long>{
	@Query(value = "SELECT * FROM SECURITY.USERS WHERE EMAIL = ?", nativeQuery = true)
    User findByEmail(String email);
	@Query(value = "INSERT INTO SECURITY.USERS (EMAIL, PASSWORD, FIRST_NAME, LAST_NAME, PHONE_NUMBER) VALUES(?1, ?2, ?3, ?4, ?5); INSERT INTO SECURITY.USER_ROLE ()", nativeQuery = true)
